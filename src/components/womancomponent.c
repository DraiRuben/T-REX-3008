...
{
	WomanComponent_Properties* props = (WomanComponent_Properties*)properties;
	...
	H3_Object_SetVelocity(object, props->pvx * props->speed*0.75, props->pvy * props->speed*0.75);
...
{
	WomanComponent_Properties* properties = malloc(sizeof(WomanComponent_Properties));
	...
	//load texture anim
	properties->TxRunDown	= H3_Texture_Load("assets/Sprites/Woman/WomanMovefront.png", &properties->TxW, &properties->TxH);
	properties->TxRunUp		= H3_Texture_Load("assets/Sprites/Woman/WomanMoveBehind.png", &properties->TxW, &properties->TxH);
	properties->TxRunLeft	= H3_Texture_Load("assets/Sprites/Woman/WomanMoveLeft.png", &properties->TxW, &properties->TxH);
	properties->TxRunRight	= H3_Texture_Load("assets/Sprites/Woman/WomanMoveRight.png", &properties->TxW, &properties->TxH);
	properties->TxIdleDown	= H3_Texture_Load("assets/Sprites/Woman/WomanIdleFront.png", &properties->TxW, &properties->TxH);
	properties->TxIdleUp	= H3_Texture_Load("assets/Sprites/Woman/WomanIdlebehind.png", &properties->TxW, &properties->TxH);
	properties->TxIdleLeft	= H3_Texture_Load("assets/Sprites/Woman/WomanIdleLeft.png", &properties->TxW, &properties->TxH);
	properties->TxIdleRight	= H3_Texture_Load("assets/Sprites/Woman/WomanIdleRight.png", &properties->TxW, &properties->TxH);


	properties->direction = 3; //down
	return properties;
}
H3_DEFINE_COMPONENT_PROPERTY_ACCESSORS_RO_EX(WomanComponent,WOMANCOMPONENT_TYPEID, bool, IsSprint);
H3_DEFINE_COMPONENT_PROPERTY_ACCESSORS_RW_EX(WomanComponent, WOMANCOMPONENT_TYPEID, float, slowdown);
H3_DEFINE_COMPONENT_PROPERTY_ACCESSORS_RW_EX(WomanComponent, WOMANCOMPONENT_TYPEID, bool, playerWin);