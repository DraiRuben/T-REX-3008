...
void* SpawnerComponent_CreateProperties(H3Handle* player,H3Handle* GameScene, H3Handle energyBar, bool* IsNewWave, bool* IsWave,bool* GlobalAggro,bool* IsFinalRush);


H3_CAPI_END_BLOCK

#define SPAWNERCOMPONENT_CREATE(PLAYER,GAMESCENE,ENERGYBAR,ISNEWWAVE,ISWAVE,GLOBALAGGRO,ISFINALRUSH)                                          \
	(SH3Component) {                                                            \
		...
		.properties         = SpawnerComponent_CreateProperties(PLAYER,GAMESCENE,ENERGYBAR,ISNEWWAVE,ISWAVE,GLOBALAGGRO,ISFINALRUSH) \
	}
